...
namespace Kelmen.ONI.Mods.ConduitFilters.DiseaseFilters
{
    ...
    public class LiquidDiseaseFilter : IBuildingConfig
    {
        public const string ID = "Kelmen-LiquidDiseaseFilter";

        public const string DisplayName = "Liquid Disease Filter";
        public const string Description = "Route liquid with any disease to 2nd outflow.";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            buildingDef.EnergyConsumptionWhenActive = 20; // 1 liquid pipe germ sensor + 2 liquid shutfoff
